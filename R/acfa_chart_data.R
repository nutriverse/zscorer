...
#' get_acfa_zchart
#'
#' Function to extract arm circumference-for-age z-score data from the World Health
...
#' growth charts for arm circumference-for-age z-scores.
#'
...
#'     \code{-4SD}}
#' \item{\code{sd_value}}{Arm circumference (in centimetres) value for the specified
#'     \code{sd_type}}
#' }
#'
#' @examples
#' # Get arm circumference-for-age z-score expanded tables for charting
#' get_acfa_zchart()
#'
#' @export
#'
...
#' get_acfa_pchart
#'
#' Function to extract arm circumference-for-age percentiles data from the World Health
#' Organization (WHO) website on Child Growth Standards
#' \url{http://www.who.int/childgrowth/standards/"} which contains a
#' collection of reference data from the WHO Multicentre Growth Reference Study
#' (MGRS). This function extracts the expanded data provided by WHO for creating
...
#'
#' @examples
#' # Get arm circumference-for-age percentiles expanded tables for charting
#' get_acfa_pchart()
#'
#' @export
#'
