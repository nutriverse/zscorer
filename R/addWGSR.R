...
#'
#' @param thirdPart Name of varible specifying age (in days) for BMI/A
#'
#'     Give a quoted variable name as in (e.g.) "age".
#'
...
#'     added to the dataset. This ia an optional parameter. If you do not specify
