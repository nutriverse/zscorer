...
#'
#' @examples
#'   # apply \code{get_zscore_all()} to a make believe 52 month old male child with
#'   # weight of 14.6 kg and height of 98.0 cm
#'   waz <- get_zscore_all(sex = 1,          # 1 = Male / 2 = Female
...
#'   whz
#'
#'   # apply \code{get_zscore_all()} to \code{anthro1} dataset
#'   waz <- get_zscore_all(data = anthro1,
#'                         sex = "sex",
#'                         weight = "weight",
#'                         height = "height",
#'                         age = "age",
...
#'   waz
#'
#'   haz <- get_zscore_all(sex = anthro1$sex,
...
#'   haz
#'
#'   all <- get_zscore_all(data = anthro1,
#'                         sex = "sex",
#'                         weight = "weight",
#'                         height = "height",
#'                         age = "age",
